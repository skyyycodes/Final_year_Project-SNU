...
\usepackage{bicaption}         % Bilingual captions for figures/tables
...
\usepackage[inline]{asymptote} % vector graphics (Asymptote language)
\usepackage{tikz}              % drawing diagrams
\usetikzlibrary{arrows,automata} % arrows, automata states
\usetikzlibrary{calc}          % coordinate calculations in TikZ
\usepackage{overpic}           % Place LaTeX content over pictures
\usepackage{epsfig,color}      % EPS figures and colors
...
% ==================NOTES / ANNOTATIONS====================================
\usepackage{todonotes}      % Add TODO notes in margin / inline, for \cdots

% ==================GLOSSARY===============================================
\usepackage[nonumberlist,nogroupskip,xindy]{glossaries} % Glossary & acronyms
...
\include{chapter3-problem-identification}

\include{chapter4-proposed-solution}

\include{chapter5-experimental-results}
